...
between the sensor and the FEI4-B readout chip (for a discussion of this issue see for example~\cite{rossi2006pixel}), it could not be biased up to full depletion. Hence there are not be
