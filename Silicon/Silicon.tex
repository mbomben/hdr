...
probability (see~\ref{sec:trapping})~\cite{	}.
...
In the studies performed to determine the fluence and time dependence of the full depletion voltage 
simple unstructured diodes were used and the full depletion voltage was deduced from CV 
measurements (Eq.~\ref{eq:CV}). This method assumes a constant space charge which is not given 
...
Due to the mobility of defects the net doping concentration changes after the end of the irradiation. 
