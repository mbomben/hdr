...
Modern CMOS imaging sensors make use of 3D integration\footnote{3D  integration  is  a  method  of  electrically  connecting  chips  
that  consist  of  different  kinds  of  devices by stacking them~\cite{6690968}} of sensor and readout electronics, to combine high resistivity and 
