...
Excellent books and reviews on the subject exists, like~\cite{Lutz:411172,Sze1981,Wang1989,Krammer,Shockley,rossi2006pixel,Hartmann2012}. 
...
by a dedicated frontend electronics channel; sensor and readout electronics are physically separated 
...
by the HPDs. One solution is to have on the same substrate the sensor and the electronics: 
 simple electronics circuits (like the first stage of the amplifier of each pixel and some addressing 
 scheme) are integrated on high-resistivity silicon. 
