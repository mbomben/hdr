...
Ionising charged particles traversing the detector 
...
In Figure~\ref{fig:n-on} the schematics representations  of n-on-p and n-on-p 
silicon detectors are shown.

\begin{figure}[htbp]
   \centering
   \includegraphics[width=0.45\textwidth]{n-on-p.pdf} 
    \includegraphics[width=0.45\textwidth]{n-on-n.pdf}
   \caption{\label{fig:n-on} Silicon detectors sketch. (Left) N-on-p; (right) n-on-n.}
\end{figure}
