...
\date{26 mars 2018}
\jurya{Alessandra Tonazzo}{APC \& Paris Diderot, Paris}{Pr\'esident du Jury}
\juryb{Dominik Dannheim}{CERN, Geneva}{Rapporteur}
\juryc{Fran\c{c}ois Le Diberder}{LAL \& Paris Diderot, Paris}{Rapporteur}
\juryd{Achille Stocchi}{LAL \& Paris Sud, Paris}{Rapporteur}
\jurye{Daniela Bortoletto}{University of Oxford, Oxford}{Examinateur}
\juryf{Anna Macchiolo}{Max-Planck-Institut for Physics, M\"unich}{Examinateur}
\juryg{Marc Winter}{IPHC, Strasbourg}{Examinateur}
...
%\includefrom{.}{dedication}
%	\newpage
 \pagestyle{fancy}
%\addcontentsline{toc}{chapter}{Acknowledgements}
\includefrom{.}{Acknowledgements}
			\tableofcontents
		% Liste des figures
			%\listoffigures
		% Liste des tableaux
