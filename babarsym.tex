...
\def\Kspiz   {\ensuremath{\KS \kern -0.16em \piz}\xspace}
\def\Ksomega   {\ensuremath{\KS \kern -0.16em \omega}\xspace}
\def\Kseta   {\ensuremath{\KS \kern -0.16em \eta}\xspace}
\def\Ksetapr   {\ensuremath{\KS \kern -0.16em \etapr}\xspace}
\def\Ksphi   {\ensuremath{\KS \kern -0.16em \phi}\xspace}
...
\def\DDstar  {\ensuremath{D^{(*)0}}\xspace}
\def\DDstarb {\ensuremath{\overline{D}^{(*)0}}\xspace}
...
\newcommand{\Btodstdlnu}{\ensuremath{B \to \Dstar(D) \ell \nu}\xspace}
\def\Btorholnu  {\ensuremath{B \to \rho \ell \nu}\xspace}
\def\BztoDstlnu {\ensuremath{\mbox{\Bz \to \Dstarm \ellp \nul}}\xspace}
\def\BzbtoDstlnu {\ensuremath{\Bzb \to \Dstarp \ellm \nulb}\xspace}
\def\BztoDlnu {\ensuremath{\Bz \to \Dm \ellp \nul}\xspace}

\def\BztoDstlnuX {\ensuremath{\mbox{\Bz \to \Dstarm \ellp \nul \X}}\xspace}
...
\newcommand{\BDh}{\ensuremath{\Bz \to \DDstarb h^0}\xspace}
...
\newcommand{\dilution} {\ensuremath{\mathcal{D}}\xspace}
...
\newcommand{\deltamd}{\ensuremath{\Delta m_{d}}\xspace}
