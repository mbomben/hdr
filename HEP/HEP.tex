...
The collective name for all these deflections is {\it multiple scattering} (MS).
...
$\theta_{MS}$ is the the multiple scattering angle (presented in Equation~\ref{eq:thetaMS}), and and $r_{pv}$ the distance 
of the first  layer to the primary interaction vertex. Minimising material and getting layer as 
close as possible to the primary vertex helps; on the contrary, adding many layers here do not work 
