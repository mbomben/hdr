...
%\AddToShipoutPicture*{\EtiquetteThese}
  \begin{titlepage}
  \centering
  \includegraphics[width=0.3\textwidth]{Logo_of_Paris_Diderot_University.jpg}
      \hfill
      \includegraphics[width=0.3\textwidth]{LPNHE.jpg}\\
    \vspace{1cm}
      {\Large Universit\'e Paris - Diderot}\\
    \vspace{1cm}
      {\Large
      	{\bfseries HABILITATION A DIRIGER DES RECHERCHES}\\
    \vspace{0.4cm}}
       	%{\huge\bfseries \@ecole}\\
    \vspace{0.4cm}
    	{\large{\bfseries Spécialité :  `` physique des particules ''}}\\
    \vspace{1.5cm}
	...
	\textbf{Laboratoire de Physique Nucl\'eaire et de Hautes Energies - LPNHE\\
	UMR CNRS 7585 \\
	4 place Jussieu
75005 Paris, France}\\
  \end{titlepage}
